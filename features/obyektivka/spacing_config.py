...
HDR_NAME_BOTTOM_MM = _float_env("OBY_HDR_NAME_BOTTOM_MM", 3.5)
FIELD_ROW_GAP_MM = _float_env("OBY_FIELD_ROW_GAP_MM", 2.82)
CURRENT_JOB_BOTTOM_MM = _float_env("OBY_CURRENT_JOB_BOTTOM_MM", 2.82)
SECTION_WORK_MARGIN_TOP_MM = _float_env("OBY_SECTION_WORK_MARGIN_TOP_MM", 1.41)
SECTION_WORK_MARGIN_BOTTOM_MM = _float_env("OBY_SECTION_WORK_MARGIN_BOTTOM_MM", 1.41)
