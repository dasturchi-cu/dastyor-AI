...
def setup_application():
    ...
    application.add_handler(CommandHandler("referal",     spanify("bot:cmd_referal", referral_link_command)))
    application.add_handler(CommandHandler("referral",    spanify("bot:cmd_referral", referral_link_command)))
    application.add_handler(CommandHandler("invite",      spanify("bot:cmd_invite", referral_link_command)))
    ...
    application.add_handler(CommandHandler("resume",      spanify("bot:cmd_resume", cmd_cv)))
    application.add_handler(CommandHandler("rezyume",     spanify("bot:cmd_rezyume", cmd_cv)))
    application.add_handler(CommandHandler("obyektivka",  spanify("bot:cmd_obyektivka", cmd_obyektivka)))
    application.add_handler(CommandHandler("oby",         spanify("bot:cmd_oby", cmd_obyektivka)))
    ...
    application.add_handler(CommandHandler("lotin",       spanify("bot:cmd_lotin", cmd_translit)))
    application.add_handler(CommandHandler("kirill",      spanify("bot:cmd_kirill", cmd_translit)))
    application.add_handler(CommandHandler("translate",   spanify("bot:cmd_translate", cmd_translate)))
    application.add_handler(CommandHandler("tarjima",     spanify("bot:cmd_tarjima", cmd_translate)))
    application.add_handler(CommandHandler("premium",     spanify("bot:cmd_premium", cmd_premium)))
    application.add_handler(CommandHandler("balans",      spanify("bot:cmd_balans", balance_handler)))
    application.add_handler(CommandHandler("balance",     spanify("bot:cmd_balance", balance_handler)))
    application.add_handler(CommandHandler("more",        spanify("bot:cmd_more", more_menu_handler)))
    application.add_handler(CommandHandler("tools",       spanify("bot:cmd_tools", more_menu_handler)))
    application.add_handler(CommandHandler("spell",       spanify("bot:cmd_spell", spell_check_handler)))
    application.add_handler(CommandHandler("imlo",        spanify("bot:cmd_imlo", spell_check_handler)))
