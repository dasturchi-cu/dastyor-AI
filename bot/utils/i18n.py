...
_DICT = {
    ...
    "balance_footer_hint": {
        ...
        "uz_cyr": "💡 Premium ва тарифларни Web mini-appдаги **💎 Premium** саҳифасидан оласиз.",
        "en": "💡 You can buy Premium/plans in the Web mini app → **💎 Premium** page.",
        "ru": "💡 Premium/тарифы можно купить в Web mini‑app → странице **💎 Premium**."
    },
    "status_prem": {
